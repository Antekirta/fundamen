  ...
  >
    <div class="relative isolate pb-32 pt-6 sm:pt-24">
      ...
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto mt-0 grid max-w-2xl grid-cols-1 grid-rows-1 gap-8 text-sm leading-6 text-gray-900 sm:grid-cols-2 xl:mx-0 xl:max-w-none xl:grid-flow-col xl:grid-cols-4">
          <the-testimonial-big
            :author="featuredTestimonial.author"
            :body="featuredTestimonial.body"
          />
